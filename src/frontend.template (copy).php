  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="//codeply.com">Terms and Pivacy</a>
            </li>
<!--             <li class="nav-item">
 ...
 -->        </ul>
    ...
    <div class="mx-auto order-0">
        <a class="navbar-brand mx-auto" href="#">
            <img src="assets/img/w2.png" width="45" height="45" alt=""></a>
...
<!--                <br>-->
        ...
        <small class="text-justify quick-summary" >
         ...
         <div class="card card-body collapse" id="contact" style="max-width: 40rem">
